...
public enum Relationship {
    ...
    public static boolean matchCondition(Map<String, String> srcData, Field field, Relationship relationship, String condition) {
       ...
       switch (field.getType()) {
            ...
            case "varchar":
                ...
                break;
           case "date":
               result= DateUtils.strToDate(srcDataValue).compareTo(DateUtils.strToDate(condition));
               break;
           case "datetime":
               result=DateUtils.strToDate(srcDataValue,DateUtils.format_YYYY_MM_DD)
                       .compareTo(DateUtils.strToDate(condition,DateUtils.format_YYYY_MM_DD));
               break;
            default:
                try {
                    throw new Exception("条件限定不匹配");
     ...
     * @return
     */
    public static boolean matchJionCondition(Map<String, String> data1,Map<String, String> data2,
