...
public class StringUtil {
    ...
    public static List<String> parseProjection(String str, String tableName, Map<String, Field> fieldMap) {
        ...
        //如果是 * 那么投影所有字段
        if ("*".equals(str)) {
            projectionList.addAll(fieldMap.keySet());
        }
     ...
     * @return
     */
    public static List<Map<String, String>> parseWhereJoin(String str, Map<String, Map<String, Field>> fieldMaps) {
    ...
    public static Map<String, Field> parseCreateTable(String fieldsStr) {
        ...
        for (String line : lines) {
            ...
            //如果是主键字段后面加*
            field.setPrimaryKey(3 == property.length && "*".equals(property[2]));
